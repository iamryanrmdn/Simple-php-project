...
<body>
    ...
    <!-- Content -->
    <br>
    <p class="text-center">Selamat datang, <?= $_SESSION['username']; ?>! Anda telah login!</p>
    <br>
    <div class="container">
        ...
        <div class="row my-2">
            <div class="col-md">
                <!-- <a href="tambah.php" class="btn btn-primary"><i class="bi bi-person-plus-fill"></i>&nbsp;Booking</a> -->
                <a href="informasi.php" class="btn btn-success"><i class="bi bi-person-plus-fill"></i>&nbsp;Informasi Booking</a>
